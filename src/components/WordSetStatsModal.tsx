...
export default function WordSetStatsModal({ wordSetId, targetLang, onClose }: WordSetStatsModalProps) {
  ...
  return (
    <div className="fixed inset-0 bg-emerald-900/80 z-[100] overflow-y-auto p-4 sm:p-8 flex justify-center items-center backdrop-blur-sm">
      <div className="max-w-3xl w-full bg-white rounded-3xl shadow-2xl p-6 sm:p-10 relative">
        ...
        <div className="mb-8">
          <h3 className="text-2xl font-bold text-emerald-900 mb-4 flex items-center gap-2">
            <BarChart2 className="text-emerald-600" /> Historical Word Stats
          </h3>
